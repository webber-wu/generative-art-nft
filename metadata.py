...
BASE_IMAGE_URL = "ipfs://QmdKxGMz65dQQxC4iSMPfXsrPqMuSsqbcwCUgUVSZY5Jmk"
BASE_NAME = "Rinkeby Smoking Dragon #"

BASE_JSON = {
    "name": BASE_NAME,
    "description": "A collection of 1,000 Smoking Dragon on the Ethereum Blockchain",
